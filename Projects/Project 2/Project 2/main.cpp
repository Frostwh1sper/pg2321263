...
void mstrmind(int,int,char [],char []);
void cntinue();
...
bool menSel(){
    ...
    switch(sel){
        ...
        //Game begins
        case 3:{
            getCode(code,guess,numCol);
            mstrmind(numCol,numTurn,code,guess);
            break;
        }
 ...
 * 
 */
void mstrmind(int length, int turns, char code[], char guess[]){
    ...
    */
    ...
    do{
        ...
        //Check input and output results of guess
        check(code,guess,length,counter,turns);
 ...
 * 
 */
void check(char code[], char guess[], int length, int &counter, int turns){
